	...
	*/
	...
	public String consultaDetallePlanSfpa(Integer idPlanSfpa) {
		...
		queryUtil.select("SPSFPA.ID_PLAN_SFPA as idPlanSfpa", "SPSFPA.NUM_FOLIO_PLAN_SFPA as numFolioPlanSfpa",
				...
				"DATE_FORMAT(SPSFPA.FEC_INGRESO,'%d/%m/%Y')",
				...
				.leftJoin("SVC_ESTADO e", "e.ID_ESTADO = SP.ID_ESTAD")
				.leftJoin("SVC_ESTADO e2", "e2.ID_ESTADO = SP2.ID_ESTAD")
				.leftJoin("SVC_ESTADO e3", "e3.ID_ESTADO = SP3.ID_ESTAD")
				.leftJoin("SVC_ESTADO e4", "e4.ID_ESTADO = SP4.ID_ESTAD")
