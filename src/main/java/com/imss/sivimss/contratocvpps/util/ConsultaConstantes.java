...
public class ConsultaConstantes {
	...
	public static final String CURRENT_DATE = "CURRENT_TIMESTAMP()";
	...
	public static SelectQueryUtil detalleContratante () {
		...
		queryUtil.select(
				...
				"P.NOM_PRIMER_APELLIDO AS nomPersonaPaterno",
				"P.NOM_SEGUNDO_APELLIDO AS nomPersonaMaterno",
				"IFNULL(P.NUM_SEXO,'') AS numSexo",
				"IFNULL(P.REF_OTRO_SEXO,'') AS desOtroSexo",
				"P.FEC_NAC as fecNacimiento",
				"IFNULL(P.ID_PAIS,'') AS idPais",
				"IFNULL(P.ID_ESTADO,'') AS idEstado",
				"IFNULL(P.REF_TELEFONO,'') AS telefono",
				"IFNULL(P.REF_TELEFONO_FIJO,'') AS desTelefono",
				"P.REF_CORREO AS desCorreo",
