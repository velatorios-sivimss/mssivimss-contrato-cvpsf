...
public interface PlanSFPAMapper {
	...
	@Select(value = "SELECT " +
			...
			" JOIN SVT_TITULAR_BENEFICIARIOS TB ON TB.ID_TITULAR_BENEFICIARIOS = SPSA.ID_TITULAR_SUBSTITUTO " +
			" AND  TB.IND_ACTIVO = 1 " +
	...
	@Select(value = "SELECT " +
			...
			" SPSA.FEC_INGRESO as fechaIngreso," +
			...
			" INNER JOIN SVC_TIPO_PAGO_MENSUAL pg  ON  pg.ID_TIPO_PAGO_MENSUAL = SPSA.ID_TIPO_PAGO_MENSUAL  " +
			" INNER JOIN SVC_VELATORIO V  ON  V.ID_VELATORIO = SPSA.ID_VELATORIO " +
